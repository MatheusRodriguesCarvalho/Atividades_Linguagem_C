...
void criarPergunta()
{
    ...
    do{
        printf("\nDigite qual � a alternativa que est� correta: 1, 2 ou 3?");
        scanf("%i", &nova.correta);

        if(nova.correta!=1 && nova.correta!=2 && nova.correta!=3)
        {
            printf("\nOp��o inv�lida! Tem que ser 1, 2 ou 3");
        }
...
void menu()
{
    ...
    setlocale(LC_ALL, "portuguese"); // Configurar caracteres no padr�o portugu�s
    ...
    while(opcao!=3){
        ...
        switch (opcao)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                printf("\n\nEspero que tenha gostado! Ate a proxima!!!");
                break;
            default:
                printf("\n\nOp��o inv�lida! Tente novamente...");
        }
